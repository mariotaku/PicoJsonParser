...
import com.bluelinelabs.logansquare.demo.parsetasks.PicoParser;
...
import com.bluelinelabs.logansquare.demo.serializetasks.PicoSerializer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBarChart.setColumnTitles(new String[]{"GSON", "Jackson", "LoganSquare", "Moshi", "Pico"});
    ...
    private void performParseTests() {
        ...
        for (String jsonString : mJsonStringsToParse) {
            for (int iteration = 0; iteration < ITERATIONS; iteration++) {
                ...
                parsers.add(new PicoParser(mParseListener, jsonString));
            }
        }
    ...
    private void performSerializeTests() {
        ...
        for (Response response : mResponsesToSerialize) {
            for (int iteration = 0; iteration < ITERATIONS; iteration++) {
                ...
                serializers.add(new PicoSerializer(mSerializeListener, response));
            }
        }
    ...
    private void addBarData(Parser parser, ParseResult parseResult) {
        ...
        } else if (parser instanceof PicoParser) {
    ...
    private void addBarData(Serializer serializer, SerializeResult serializeResult) {
        ...
        } else if (serializer instanceof PicoSerializer) {
